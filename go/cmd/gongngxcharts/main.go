...
import (
	...
	"github.com/fullstack-lang/gongngxcharts/go/controllers"
	...
	gongngxcharts "github.com/fullstack-lang/gongngxcharts"
)
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	models.Stage.Marshall(file, "gongngxcharts/go/models", "main")
}

func main() {

	log.SetPrefix("gongngxcharts: ")
	log.SetFlags(0)
	...
	r.Use(static.Serve("/", EmbedFolder(gongngxcharts.NgDistNg, "ng/dist/ng")))
